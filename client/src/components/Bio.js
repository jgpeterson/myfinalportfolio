...
class Bio extends Component {
    render() {
        return (
            ...
            <Header />
             <FlexContainer>
    <p class="bio">My name is James Peterson and I am a full-stack Web Application Developer currently living in Atlanta, Georgia. I have a Web Development certification from GA Assembly in Atlanta. In my spare time you can find me editing videos using Adobe Premeire or editing music using Adobe Audition.
